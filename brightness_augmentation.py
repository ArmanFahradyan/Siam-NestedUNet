...
class RadicalBrightnessAugmentation(object):
    ...
    def generate_spot_light_mask(self,
                                 ...
                                 speedup=False):
        """
        Generate decayed light mask generated by spotlight given position, direction. Multiple spotlights are accepted.
        Args:
    ...
    def add_spot_light(self, image, light_position=None, max_brightness=255, min_brightness=0,
        ...
        """
        Add mask generated from spotlight to given image
        """
